...
grid$Sitio <- sp::over(ProdutividadePistola, grid)
```
...
at <- seq(at[1], at[2], length.out = 10)
...
#Exemplo de predição com suporte amostral em bloco

```{r}
rblock = as(SpatialPixelsDataFrame(pontos, pontos@data, tolerance=.00086), 
        "SpatialPolygonsDataFrame") 
spplot(rblock)
```

##Predição da PFd com suporte de área##
