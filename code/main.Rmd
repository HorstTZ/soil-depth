...
Com uma análise preliminar avaliei a distribuição de freqüências dos dados de profundidade do solum. 
...
```{r, message=FALSE, warning=FALSE, fig.cap="5 Mapa de profundidade do solum predito pelo modelo floresta aleatória"}
beginCluster()
prediction <- 
...
Análise de variância com DIC, considerando o índice de sítio como tratamento.
De acordo com o teste de Shapiro-Wilk a 5% de significancia, os residuos podem ser considerados normais.
De acordo com o teste F, as medias nao podem ser consideradas diferentes.

```{r}
dic(pontos$Sitio,pontos$PFd, mcomp="tukey")
```